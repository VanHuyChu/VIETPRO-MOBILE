...
?>
        ...
        <form method="post">
            ...
            ?>
                <div class="cart-item row">
                    ...
                    <div class="cart-price col-lg-3 col-md-3 col-sm-12"><b><?php echo $total_price; ?></b><a href="modules/cart/cart_dell.php?prd_id=<?php echo $row['prd_id']; ?>">Xóa</a></div>
    ...
    if (isset($_POST["name"]) && isset($_POST["phone"]) && isset($_POST["mail"]) && isset($_POST["add"])) {
        ...
        <td width="20%"><b>
                <font color="#FF0000">' . $total_price_all . ' đ</font>
            </b></td>
        </tr>
        </table>
...
<?php } else { ?>
    <div class="alert alert-danger mt-3">Gio hang khong co san pham</div>
<?php }
?>