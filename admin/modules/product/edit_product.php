                ...
                <div class="panel-body">
                    <div class="col-md-6">
                        <form role="form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label>Title</label>
                                <input type="text" name="title" required value="<?php echo $row_prd['prd_title'];?>" type="text" class="form-control">
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <br>
                            <div>
                                <img src="img/product/<?php echo $row_prd['prd_image'];?>">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <select name="cat_id" class="form-control">
                                ...
                                while($row_cat=mysqli_fetch_array($query_cat)){?>
                                    <option <?php if($row_prd['cat_id']==$row_cat['cat_id']){echo 'selected';}?> value=<?php echo $row_cat['cat_id'];?>><?php echo $row_cat['cat_name'];?></option>
                                <?php }?>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="prd_status" class="form-control">
                                <!-- <option value=<?php echo $row_prd['prd_status'];?>><?php if($row_prd['prd_status']==0){ echo "het hang";}else{echo 'Còn hàng';};?></option>
                                <option value=<?php echo $row_prd['prd_status'];?>>Het hang</option> -->
